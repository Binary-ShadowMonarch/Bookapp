...
<form class="form" on:submit|preventDefault={handleSubmit}>    
      <div class="text-lg justify-center flex font-bold text-gray-900 dark:text-gray-100 select-none">
      <a href="/" class="flex items-center gap-2" aria-label="Homepage">
        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-blue-400 to-purple-500">
  ...
  <div class="forgot-container">
    <button type="button" class="link" on:click={onForgotPassword}>Forgot password?</button>
  </div>

  <button type="submit" class="button-submit signin">Sign In</button>

  <p class="p">
    Don't have an account? <button type="button" class="link-inline" on:click={onSignUp}>Sign Up</button>
  </p>

  <p class="p line">Or Continue Using</p>

  <div class="flex-row">
    <button type="button" class="btn google" on:click={() => alert('Google auth')}>
            <svg
        version="1.1"
        width="20"
        id="Layer_1"
